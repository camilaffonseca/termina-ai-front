            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ width: '100%' }}>
              <Flex flexDirection='column' gap='1.2rem'>
                <Field.Root>
                  ...
                  <Input fontSize='1rem' type='text' {...register('nameTerminator')} />
                  <Field.HelperText />
                  <Field.ErrorText />
                </Field.Root>
                <Field.Root>
                  <Field.Label fontSize='1.1rem'>Seu WhatsApp</Field.Label>
                  <Input fontSize='1rem' type='tel' {...register('phoneTerminator')} />
                  <Field.HelperText />
                  <Field.ErrorText />
                </Field.Root>
                <Field.Root>
                  <Field.Label fontSize='1.1rem'>Noma da vítima</Field.Label>
                  <Input fontSize='1rem' type='text' {...register('nameTerminated')} />
                  <Field.HelperText />
                  <Field.ErrorText />
                </Field.Root>
                <Field.Root>
                  <Field.Label fontSize='1.1rem'>Telefone da vítima</Field.Label>
                  <Input fontSize='1rem' type='tel' {...register('phoneTerminated')} />
                  <Field.HelperText />
                  <Field.ErrorText />
                </Field.Root>
              </Flex>
